      ...
      <CardContent className='p-6'>
        <div className='flex flex-wrap gap-6 items-center'>
          ...
          <div className='flex-grow space-y-2 lg:ml-8'>
            <h2 className='text-2xl font-medium'>Anastasia Vasquez</h2>
            <p className='text-gray-600 text-medium'>+1(233) 232-9538</p>
            <SocialIcons />
            <Button variant='destructive' size='xs' className='pl-0'>
              Suspend
            </Button>
          </div>
          ...
          <div className='text-center px-6 py-6 bg-background rounded-lg min-w-[202px]'>
            <div className='space-y-2'>
              <p className='text-4xl font-normal lg:text-[3.375rem] text-left'>
                12
              </p>
              <p className='text-gray-medium text-left font-bold'>
                video calls
              </p>
            </div>
          </div>
